# 3dmk-implicit-reconstruction-workflow implementation handoff

This archive is the source of truth for turning the design into production code. Start from `surface-reconstruction-workflow.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `surface-reconstruction-workflow.html`
...
- A single self-contained `surface-reconstruction-workflow.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `surface-reconstruction-workflow.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `surface-reconstruction-workflow.html`

## Styles
- None detected

## Scripts/components
- `check-surface-reconstruction-workflow.mjs`

## Assets and supporting files
- `brand-spec.md`

## Coding checklist for AI tools
1. Inspect `surface-reconstruction-workflow.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
